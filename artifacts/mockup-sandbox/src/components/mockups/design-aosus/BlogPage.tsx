...
const POSTS = {
  ...
  ar: [
    { title: 'مجتمع أسس يرعى هاكاثون Daydream لطلاب المدارس بالإسكندرية', date: '18 سبتمبر 2025', author: 'FarisZR', tag: 'المجتمع', excerpt: 'يسر مجتمع أُسُس أن يعلن عن رعايته لحدث Daydream Alexandria الذي سيُقام في مدينة الإسكندرية.', link: `${BASE}/site/article`, thumb: `${BASE}/images/hero-1.png` },
