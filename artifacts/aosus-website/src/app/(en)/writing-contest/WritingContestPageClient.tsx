...
const CONTENT = {
  en: {
    ...
    steps: {
      ...
      items: [
        {
          step: "01",
          title: "Publish Your Topic",
          desc: "Post a topic about free software that meets the contest criteria on the Aosus community forum.",
          icon: PenTool,
        },
        {
          step: "02",
          title: "Winner Selection",
          desc: "At the end of each month, the oversight committee selects the winning articles.",
          icon: Trophy,
        },
        {
          step: "03",
          title: "Announce Winners",
          desc: "Winners are announced on the official Aosus community blog.",
          icon: Newspaper,
        },
        {
          step: "04",
          title: "Content Republished",
          desc: "Winning articles are republished on the GnulinuxSA blog with author attribution.",
          icon: Share2,
        },
      ],
    },
    ...
    pastWinners: {
      ...
      items: [
        {
          title: "Writing Contest Looking for New Sponsor",
          date: "Dec 2022",
        },
        {
          title: "October 2022 Winners Announced",
          date: "Oct 2022",
        },
        {
          title: "September 2022 Winners Announced",
          date: "Sep 2022",
        },
      ],
    },
  ...
  ar: {
      ...
      items: [
        {
          step: "01",
          title: "انشر موضوعك",
          desc: "قم بنشر موضوع يهتم بالبرمجيات الحرة يوافق شروط الجائزة على مجتمع أسس.",
          icon: PenTool,
        },
        {
          step: "02",
          title: "اختيار الفائزين",
          desc: "في نهاية كل شهر، سيتم اختيار المقالات الفائزة من قبل هيئة الإشراف.",
          icon: Trophy,
        },
        {
          step: "03",
          title: "الإعلان عن الفائزين",
          desc: "سيتم الإعلان عن الفائزين على مدونة مجتمع أسس الرسمية.",
          icon: Newspaper,
        },
        {
          step: "04",
          title: "نقل الموضوع",
          desc: "سيتم نسخ المواضيع الفائزة إلى مدونة GnulinuxSA مع إبقاء اسم الكاتب.",
          icon: Share2,
        },
      ],
    },
    ...
    pastWinners: {
      ...
      items: [
        {
          title: "جائزة أسس للكتابة تبحث عن راعٍ جديد",
          date: "ديسمبر 2022",
        },
        {
          title: "إعلان الفائزين لشهر أكتوبر",
          date: "أكتوبر 2022",
        },
        {
          ...
          <div className={`min-h-screen ${isDark ? "" : "bg-gray-50"}`}>
            <section className="relative py-24 overflow-hidden border-b border-[#008a2f]/20">
              ...
              <div className="relative max-w-4xl mx-auto px-6 text-center">
                ...
                <p
                  className={`text-lg mb-4 max-w-2xl mx-auto ${isDark ? "text-gray-400" : "text-gray-600"}`}
                  style={{ fontFamily: ff }}
                >
                  {t.subtitle}
                </p>
                ...
                <div
                  className={`flex items-center justify-center gap-2 text-sm ${isDark ? "text-gray-500" : "text-gray-400"}`}
                >
            ...
            <section
              className={`py-20 ${isDark ? "bg-black/40" : "bg-white"}`}
            >
                  ...
                  {t.steps.items.map((step, i) => (
                    ...
                    >
                      <CyberCard
                        ...
                        hover={false}
                      >
                        <div className="text-2xl font-bold font-mono text-[#008a2f] mb-3">
                          {step.step}
                        </div>
                  ...
                  <ul className="space-y-4">
                    {t.rules.items.map((rule, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <span className="text-[#008a2f] font-mono text-sm mt-0.5">
                          {">"}
                        </span>
                        <span
            ...
            >
              <div className="max-w-4xl mx-auto px-6">
                ...
                <CyberCard isDark={isDark} className="p-6" hover={false}>
                  ...
                  <a
                    href="https://opencollective.com/aosus"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm font-mono text-[#008a2f] hover:underline"
                  >
                    Open Collective →
                  </a>
                </CyberCard>
                ...
                <div className="space-y-4">
                  {t.pastWinners.items.map((item, i) => (
                    <CyberCard key={i} isDark={isDark} className="p-4">
                      <div
                        className={`text-xs font-mono mb-1 ${isDark ? "text-gray-600" : "text-gray-400"}`}
                      >
                        {item.date}
                      </div>
                      <h3
            ...
            <section
              className={`py-16 border-t border-[#008a2f]/20 ${isDark ? "bg-[#008a2f]/5" : "bg-[#008a2f]/5"}`}
            >
