    ...
    blog: [
      {
        ...
        link: "/ar/blog/aosus-sponsors-daydream",
      },
      {
        title: "ساهم في ترجمة Firefox!",
        date: "٢٠٢٥-٠٩-٠١",
        excerpt:
          "Mozilla تحتاج مساعدتك لتحسين دعم اللغة العربية في Firefox.",
        link: "/ar/blog/contribute-translating-firefox",
      },
      {
        title: "إيقاف خدمة Piped",
        date: "٢٠٢٥-٠٨-١٥",
        excerpt:
          "خدمة Piped تواجه مشاكل في التشغيل. نعلن عن الإيقاف القريب.",
        link: "/ar/blog/piped-service-discontinuation",
      },
    ],
      ...
      {({ lang, isDark }) => {
        ...
        return (
          <>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div className="max-w-3xl mx-auto text-center space-y-8">
                  ...
                  >
                    ...
                    <SecondaryButton
                      href={lang === "ar" ? "/ar/services" : "/services"}
                      isDark={isDark}
                    >
                      {t.ctaExplore}
                    </SecondaryButton>
            ...
            <section
              className={`py-20 ${isDark ? "bg-black/40" : "bg-gray-50/80"} border-y border-[#008a2f]/10 backdrop-blur-sm`}
            >
                  ...
                  {t.stats.map((stat, i) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={`text-3xl sm:text-4xl font-bold mb-2 font-mono group-hover:text-[#008a2f] transition-colors ${isDark ? "text-white" : "text-gray-900"}`}
                        >
                          {stat.value}
                        </div>
                        <div
                          className={`text-xs uppercase tracking-widest font-mono ${isDark ? "text-gray-500" : "text-gray-400"}`}
                        >
                          {stat.label}
                        </div>
                      </CyberCard>
            ...
            <section
              className={`py-24 ${isDark ? "bg-black/40" : "bg-gray-50/80"} border-y border-[#008a2f]/10`}
            >
            ...
            <section
              className={`py-20 border-t border-[#008a2f]/20 ${isDark ? "bg-[#008a2f]/5" : "bg-[#008a2f]/5"}`}
            >
