...
import Layout, { CyberCard, PrimaryButton, BASE, type Lang } from '../components/layout/Layout';
            ...
            <div className="max-w-3xl mx-auto px-6">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                <nav className={`flex items-center gap-2 text-xs font-mono mb-8 ${isDark ? 'text-gray-600' : 'text-gray-400'}`}>
                  <Link href={homeLink} className="hover:text-[#008a2f] transition-colors">{t.breadcrumb[0]}</Link>
                  <span className="text-[#008a2f]">/</span>
                  <Link href={blogLink} className="hover:text-[#008a2f] transition-colors">{t.breadcrumb[1]}</Link>
                  <span className="text-[#008a2f]">/</span>
                ...
                <div className={`border-t border-[#008a2f]/20 pt-8`}>
                  <Link href={blogLink} className={`flex items-center gap-3 group ${isDark ? 'text-gray-400 hover:text-[#008a2f]' : 'text-gray-500 hover:text-[#008a2f]'} transition-colors`}>
