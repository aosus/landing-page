...
describe("remarkLinkPreviews", () => {
  ...
  it("should transform standalone links into hover cards", async () => {
    ...
    expect(output).toContain("class=\"group relative inline-block underline decoration-2 decoration-zinc-300 dark:decoration-zinc-700 hover:decoration-green-500 transition-colors\"");
