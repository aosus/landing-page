...
const CONTENT = {
  en: {
    title: "Support_Us",
    subtitle:
      "Help Aosus continue its mission to promote free and open-source software in the Arabic world.",
    donateTitle: "Donate_Directly",
    donateDesc:
      "Aosus is fiscally sponsored by The Hack Foundation (d.b.a. Hack Club), a 501(c)(3) nonprofit (EIN: 81-2908499). Your donations are tax-deductible in the United States.",
    monthly: "Monthly",
    ...
    githubDesc:
      "Sponsor Aosus on GitHub and get a badge showing your support for the community.",
    ...
    referrals: {
      ...
      items: [
        {
          name: "Hetzner Cloud",
          desc: "Get 20 EUR credit on Hetzner Cloud when you use this referral link.",
  ...
  ar: {
    title: "ادعمنا",
    subtitle:
      "ساعد أسس في مواصلة مهمتها لتعزيز البرمجيات الحرة والمفتوحة المصدر في العالم العربي.",
    donateTitle: "تبرع_مباشرة",
    donateDesc:
      "أسس مستضاف مالياً من The Hack Foundation (المعروفة باسم Hack Club)، منظمة غير ربحية من نوع 501(c)(3) (رقم EIN: 81-2908499). تبرعاتك معفاة ضريبياً في الولايات المتحدة.",
    monthly: "شهري",
    ...
    githubDesc:
      "بإمكانكم رعاية أسس على منصة GitHub والحصول على علامة تدل على دعمكم.",
    githubLink: "https://github.com/sponsors/aosus",
    referrals: {
      title: "روابط_الإحالة",
              ...
              <div className="max-w-4xl mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p
                      className="text-sm leading-relaxed mb-6 text-gray-600 dark:text-gray-400"
                      style={{ fontFamily: ff }}
                    >
                      {t.donateDesc}
                    </p>
                    <div className="flex flex-wrap gap-3 mb-6">
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-5 py-3 font-mono uppercase tracking-wider border border-gray-300 text-gray-700 transition-all hover:border-[#008a2f] hover:text-[#008a2f] dark:border-white/20 dark:text-gray-300"
                      >
                    ...
                    <a
                      href={t.financialLink}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm font-mono text-[#008a2f] hover:underline flex items-center gap-1"
                    >
                ...
                <CyberCard isDark={isDark} className="p-8" hover={false}>
                  <ul className="space-y-4">
                    {t.impacts.map((impact, i) => (
                      ...
                      >
                        <span className="text-[#008a2f] font-mono text-sm">
                          {">"}
                        </span>
                        <span
