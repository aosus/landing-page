          ...
          <div className="min-h-screen bg-gray-50 dark:bg-transparent">
            <section className="relative py-24 overflow-hidden border-b border-[#008a2f]/20">
              ...
              <div className="relative max-w-4xl mx-auto px-6 text-center">
                ...
                <p
                  className="text-lg mb-4 max-w-2xl mx-auto text-gray-600 dark:text-gray-400"
                  style={{ fontFamily: ff }}
                >
                  {t.subtitle}
                </p>
            ...
            <section className="py-20 bg-white dark:bg-black/40">
            ...
            <section className="py-20 bg-white dark:bg-black/40">
              <div className="max-w-4xl mx-auto px-6">
                ...
                <CyberCard isDark={isDark} className="p-6" hover={false}>
                  <p
                    className="text-sm leading-relaxed mb-4 text-gray-600 dark:text-gray-300"
                    style={{ fontFamily: ff }}
                  >
                    {t.collection.desc}
                  </p>
            ...
            <section className="py-16 border-t border-[#008a2f]/20 bg-[#008a2f]/5">
